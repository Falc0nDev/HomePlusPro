...
@interface HPEditorManager () <HPEditorViewControllerDelegate>
...
@implementation HPEditorManager

+ (instancetype)sharedInstance
{
    static HPEditorManager *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = (HPEditorManager *) [[[self class] alloc] init];
    });
...
- (void)loadUpImagesFromWallpaper:(UIImage *)image 
{
    ...
    */
    ...
    UIImage *b = [[HPEditorManager sharedInstance] blurredMoreBGImage];
