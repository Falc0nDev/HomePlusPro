...
-(void)layoutControllerView
{
    ...
    self.bottomControl.value = [[[HPDataManager sharedInstance] currentConfiguration] floatForKey:[NSString stringWithFormat:@"%@%@%@", @"HPData", x, @"SideInset"]];
...
- (void)bottomSliderUpdated:(UISlider *)sender
{
    ...
    [[[HPDataManager sharedInstance] currentConfiguration] setFloat:sender.value
                                                             forKey:[NSString stringWithFormat:@"HPData%@%@", x, @"SideInset"]];
